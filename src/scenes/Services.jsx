...
export default function Services() {
  ...
  return (
    <div className="services">
      <svg data-aoso="fade-left" data-aoso-duration="1500" className="floater" width="143" height="143" viewBox="0 0 143 143" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div data-aoso="zoom-in-up" data-aoso-duration="1500" className="card-holder">
      ...
      <div data-aoso="zoom-in-down" data-aoso-duration="1500" className="services-text">
